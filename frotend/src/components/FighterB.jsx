...
const FighterB = ({pokemonId, sendDataToParent}) => {
  ...
  return (
    <div className='rounded-lg h-auto p-1 border border-slate-300 w-64 mb-2 mr-0'>
        <h1 className='text-center text-2xl Felipa'>Pokemon ID <span className='text-red-500'>
            <span className='bg-lime-300 px-2 rounded-3xl'>{pokemonId}</span>
            </span></h1>
